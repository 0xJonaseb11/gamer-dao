...
export interface IMasterAccessManagementInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addPermissionsToRole" | "getRolePermissions" | "getUserRoles" | "grantRoles" | "hasMasterContractsRegistryPermission" | "hasPermission" | "removePermissionsFromRole" | "revokeRoles"): FunctionFragment;
...
export interface IMasterAccessManagement extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IMasterAccessManagementInterface;
