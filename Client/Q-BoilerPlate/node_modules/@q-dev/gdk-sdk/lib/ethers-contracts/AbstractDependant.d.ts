...
export interface AbstractDependantInterface extends utils.Interface {
    functions: {
        "getInjector()": FunctionFragment;
        "setDependencies(address,bytes)": FunctionFragment;
        "setInjector(address)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "getInjector" | "setDependencies" | "setInjector"): FunctionFragment;
...
export interface AbstractDependant extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AbstractDependantInterface;
    ...
    functions: {
        ...
        setDependencies(contractsRegistry_: PromiseOrValue<string>, data_: PromiseOrValue<BytesLike>, overrides?: Overrides & {
    ...
    callStatic: {
        getInjector(overrides?: CallOverrides): Promise<string>;
        setDependencies(contractsRegistry_: PromiseOrValue<string>, data_: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
