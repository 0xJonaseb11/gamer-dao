...
export interface DAOPoolRegistryMockInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addProxyPool" | "countPools" | "getImplementation" | "getInjector" | "getProxyBeacon" | "injectDependenciesToExistingPools" | "injectDependenciesToExistingPoolsWithData" | "listPools" | "setDependencies" | "setInjector" | "setNewImplementations"): FunctionFragment;
...
export interface DAOPoolRegistryMock extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: DAOPoolRegistryMockInterface;
