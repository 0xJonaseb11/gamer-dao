...
export interface IDAOIntegrationInterface extends utils.Interface {
    functions: {
...
export interface IDAOIntegration extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IDAOIntegrationInterface;
