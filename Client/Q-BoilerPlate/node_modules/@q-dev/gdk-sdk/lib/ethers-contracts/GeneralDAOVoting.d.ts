...
export interface GeneralDAOVotingInterface extends utils.Interface {
    functions: {
...
export interface GeneralDAOVoting extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: GeneralDAOVotingInterface;
