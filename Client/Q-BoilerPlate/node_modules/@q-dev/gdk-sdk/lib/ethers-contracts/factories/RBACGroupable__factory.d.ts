...
import type { RBACGroupable, RBACGroupableInterface } from "../RBACGroupable";
export declare class RBACGroupable__factory {
    ...
    static createInterface(): RBACGroupableInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): RBACGroupable;
}
