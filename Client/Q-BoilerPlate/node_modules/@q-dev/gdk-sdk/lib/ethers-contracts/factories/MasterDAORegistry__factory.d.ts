...
import type { MasterDAORegistry, MasterDAORegistryInterface } from "../MasterDAORegistry";
export declare class MasterDAORegistry__factory {
    static readonly abi: readonly [{
        ...
        readonly inputs: readonly [];
        readonly name: "MASTER_DAO_REGISTRY_RESOURCE";
    ...
    static createInterface(): MasterDAORegistryInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): MasterDAORegistry;
}
