...
import type { IMasterDAOFactory, IMasterDAOFactoryInterface } from "../IMasterDAOFactory";
export declare class IMasterDAOFactory__factory {
    ...
    static createInterface(): IMasterDAOFactoryInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IMasterDAOFactory;
}
