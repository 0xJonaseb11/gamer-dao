...
import type { DAOPoolRegistryMock, DAOPoolRegistryMockInterface } from "../DAOPoolRegistryMock";
export declare class DAOPoolRegistryMock__factory {
    ...
    static createInterface(): DAOPoolRegistryMockInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): DAOPoolRegistryMock;
}
