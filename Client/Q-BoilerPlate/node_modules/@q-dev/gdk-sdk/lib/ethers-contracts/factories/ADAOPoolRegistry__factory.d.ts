...
import type { ADAOPoolRegistry, ADAOPoolRegistryInterface } from "../ADAOPoolRegistry";
export declare class ADAOPoolRegistry__factory {
    ...
    static createInterface(): ADAOPoolRegistryInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): ADAOPoolRegistry;
}
