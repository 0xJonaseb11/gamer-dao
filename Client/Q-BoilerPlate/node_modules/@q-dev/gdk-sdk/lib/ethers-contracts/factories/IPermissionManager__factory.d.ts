...
import type { IPermissionManager, IPermissionManagerInterface } from "../IPermissionManager";
export declare class IPermissionManager__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): IPermissionManager;
}
