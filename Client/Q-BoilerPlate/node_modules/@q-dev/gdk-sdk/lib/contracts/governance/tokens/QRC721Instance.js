...
exports.QRC721Instance = void 0;
const SystemContractInstance_1 = require("../../SystemContractInstance");
class QRC721Instance extends SystemContractInstance_1.SystemContractInstance {
    constructor(signer, address) {
        super(signer, "QRC721.json", address);
    }
    ...
    async mintTo(receiver, tokenId, tokenURI, txOptions) {
        return this.submitTransaction("mintTo", [receiver, tokenId, tokenURI], txOptions);
    }
    async burnFrom(account, tokenId, txOptions) {
        return this.submitTransaction("burnFrom", [account, tokenId], txOptions);
    }
...
exports.QRC721Instance = QRC721Instance;
//# sourceMappingURL=QRC721Instance.js.map