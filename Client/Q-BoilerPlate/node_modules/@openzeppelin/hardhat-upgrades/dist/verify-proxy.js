...
async function attemptVerifyWithCreationEvent(hre, etherscanApi, address, possibleContractInfo, errorReport) {
    ...
    if (constructorArguments === undefined) {
        ...
        await verifyContractWithConstructorArgs(hre, etherscanApi, address, contractInfo.artifact, constructorArguments, errorReport);
    }
}
/**
 ...
 */
async function verifyContractWithConstructorArgs(hre, etherscanApi, address, artifact, constructorArguments, errorReport) {
    ...
    try {
        const status = await (0, etherscan_api_2.verifyAndGetStatus)(params, etherscanApi);
