 ...
 */
function getContractReports(sourceContracts, opts) {
    const upgradeableContractReports = [];
    for (const sourceContract of sourceContracts) {
        const upgradeabilityAssessment = (0, upgradeability_assessment_1.getUpgradeabilityAssessment)(sourceContract, sourceContracts);
